...
namespace ProjectSucess.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiceId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TotalProducts", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_TotalProducts_Category_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TotalProducts_CategoryId",
                table: "TotalProducts",
                column: "CategoryId");
        }
